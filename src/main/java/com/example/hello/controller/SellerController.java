...
public class SellerController {
    ...
    public SellerController(ProductService productService, com.example.hello.user.UserService userService, com.example.hello.service.CategoryService categoryService) {
    ...
    public String addProduct(@ModelAttribute Product product, java.security.Principal principal) {
